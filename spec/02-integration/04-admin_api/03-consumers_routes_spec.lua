...
describe("Admin API (#" .. strategy .. "): ", function()
  ...
  local function new_consumer()
    return assert(bp.consumers:insert {
      username = gensym(),
      custom_id = gensym(),
    })
  end

  local function new_plugin(consumer)
    return assert(db.plugins:insert {
      name = "rewriter",
      consumer = {
        id = consumer.id
      }
  ...
  describe("/consumers/{username_or_id}/plugins/{plugin}", function()
    ...
    describe("GET", function()
      ...
      it("retrieves by id", function()
        local consumer = new_consumer()
        local plugin = new_plugin(consumer)
